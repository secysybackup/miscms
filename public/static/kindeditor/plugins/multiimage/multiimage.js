KindEditor.plugin('multiimage', function(K) {
	...
	self.clickToolbar(name, function() {
		var html = ['<div class="ke-map" style="width:600px;height:450px;"></div>'].join('');
		...
		var iframe = K('<iframe class="ke-textarea" frameborder="0" src="' + fileManagerJson + '" style="width:600px;height:450px;border:none;"></iframe>');
		function ready() {
