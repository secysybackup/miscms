...
KindEditor.plugin('filemanager', function(K) {
	...
	self.plugin.filemanagerDialog = function(options) {
		var width = K.undef(options.width, 600),
			height = K.undef(options.height, 450),
			upUrl = options.upUrl;
			clickFn = options.clickFn;
		var html = ['<div class="ke-map" style="width:600px;height:400px;"></div>'].join('');
		...
		var iframe = K('<iframe class="ke-textarea" frameborder="0" src="' + upUrl + '" style="width:600px;height:400px;border:none;"></iframe>');
		function ready() {
