...
function footerKefu() {     //底部客服
    ...
    $(".social_nav4 .btn").bind('click', function () {
        $(".social_nav4").find(".social4").hide();
        $(".social_nav4").show();
        $(this).hide();
        $(".social_nav4 .btn2").css('left', '0').show();
    })
    $(".social_nav4 .btn2").bind('click', function () {
        $(".social_nav4").find(".social4").show();
        $(".social_nav4").show();
        $(this).hide();
        $(".social_nav4").css('left','0');
        $(".social_nav4 .btn").show();
    });
